                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="apps">
                           <li><a href="email.html">> <span>Daftar Baru</span></a></li>
                           <li><a href="calendar.html">> <span>Data Siswa</span></a></li>
                           <li><a href="media_gallery.html">> <span>Data Kaos</span></a></li>
                        </ul>
                     </li>
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       ...
                                       <li>
                                          <span><img src="images/layout_img/msg3.png" class="img-responsive" alt="#" /></span>
                                          <span>
                                          <span class="name_user">John Sena</span>
                                          <span class="msg_user">On the other hand, we denounce.</span>
                                          <span class="time_ago">12 min ago</span>
                                          </span>
                                       </li>
                  ...
                  <div class="container-fluid">
                     <div class="footer">
                        <p>Copyright © 2024 Designed by html.design. All rights reserved.<br><br>
                           Distributed By: <a href="https://themewagon.com/">Power Rangers</a>
                        </p>
                     </div>
                  </div>
               </div>
