                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="element">
                           ...
                           <li><a href="media_gallery.html">> <span>Input Gelombang</span></a></li>
                      ...
                      ?>
                        <tbody style="background-color:white;">
                          ...
                          <td style="text-align: center;">
                            ...
                            <a title="hapus" class="btn btn-danger mdi mdi-delete" style="font-size: 15px;" href="proses/pros_hapus_gel.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus
                          </a>&nbsp;
                          </td>
                        </tbody>
                        ...
                        <div class="modal fade" id="<?php echo $edit_modal_id; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form class="needs-validation" action="proses/proses_edit_gel.php" method="post">
                                  <div class="row">
                                    <div class="col-md-12 mb-3">
                                      <label for="firstName">Gelombang</label>
