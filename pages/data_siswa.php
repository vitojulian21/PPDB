                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="apps">
                           ...
                           <li><a href="calendar.html">> <span>Data Siswa</span></a></li>
                      ...
                      ?>
                        <tbody style="background-color:white;">
                          ...
                          <td style="text-align: center;">
                            ...
                            <a title="hapus" class="btn btn-danger mdi mdi-delete" style="font-size: 15px;" href="proses/pros_hapus_siswa.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus
                          </a>&nbsp;
                          </td>
                        </tbody>
                                ...
                                <form class="needs-validation" action="proses/pros_edit_baru.php" method="post">
                                  <div class="row">
                                    <div class="col-md-12 mb-3">
                                      <label for="firstName">no_pendaftaran</label>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="country">jurusan</lable>
                                        <select class="custom-select d-block w-100"
                                        name="jurusan" id="country" required="">
                                        <option value="">Pilih...</option>
                                        <option> <?php if ($row['jurusan']== 'REKAYASA PERANGKAT LUNAK') ECHO 'selected' ;?>REKAYASA PERANGAKAT LUNAK</option>
                                    
                                        <option> <?php if ($row['jurusan']== 'AKUTANSI KEUNGAN DAN LEMBAGA') ECHO 'selected' ;?>AKUTANSI KEUANGAN DAN LEMBAGA</option>
                                    
                                        <option> <?php if ($row['jurusan']== 'MENEJEMEN PERKANTORAN') ECHO 'selected' ;?>MENEJEMEN PERKANTORAN</option>
